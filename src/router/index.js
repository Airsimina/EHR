	...
	routes: [{
			...
			children: [{
				...
				},
				{
					...
					name: 'backlog',
					component: () =>
						import('../pages/backlog/index.vue'),
				},
				{
					// 申请
					path: '/apply',
		...
		},
		{
			...
			children: [{
				...
				},
				{
					...
					name: 'changeLeader',
					component: () =>
						import('../pages/changeLeader/index.vue')
				},
				{
					// 请假类型
					path: '/leaveType',
					name: 'leaveType',
					component: () =>
						import('../pages/leaveType/index.vue')
				}
			]
		}
