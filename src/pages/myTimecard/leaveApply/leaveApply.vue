            ...
            <div class="cantainer">
                <div class="box">
                    ...
                    <div class="lis" v-if="dates.length>0">
                        <div class="lis-f">
                            <div class="div-name-1">{{status == 4 ? '销假日期':'请假日期'}}</div>
                        </div>
                    ...
                    <div class="lis">
                        <div class="lis-f">
                            <div class="div-name-1">{{status == 4 ? '销假时长':'请假时长'}}</div>
                        </div>
                        <div class="lis-r">
                            <span>{{numDay}} 天</span>
                        </div>
            ...
            <div class="flow-box">
                <div class="flow-item" v-for="(item, index) in flowHiComments" :key="index">
                    ...
                    <div class="flow-info">
                        ...
                        <!-- 销售计划 右侧展示文字 -->
                        <div
                            :class="[getStatus(item.operateType)]"
                            class="status"
                        >{{item.operateType}}</div>
                    </div>
                </div>
            </div>
            <!-- 底部按钮 -->
