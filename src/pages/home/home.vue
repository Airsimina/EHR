      ...
      <div class="commission-card-container">
        <div class="current-person">
          <div class="current-item">
            <div class="item-info">
              <div>
                <van-image width="0.9rem" height="0.94rem" radius="10" fit="cover" :src="userInfo.personPhoto" />
              </div>
              <div class="item-post">&emsp;{{userInfo.name}}</div>
              <div class="item-level">{{userInfo.departmentName}}</div>
            </div>
          </div>
          <div class="commission-card">
            <div class="single-card" @click="toDb">
              <div class="discribe">待办事项</div>
              <div class="number">
                <span>{{awaitNum}}</span>
                <span class="my-arrow-right">
    ...
    <div class="bg">
      <div class="container">
        <div class="single-title">
          <img src="../../../static/img/yuangong.png" alt />
        </div>
        <div class="single-bg">
          <div class="single" @click="transmitFun(item)" v-for="(item,index) in jsonData.list_a" :key="index">
      ...
      <div class="people-container" v-show="false">
        ...
        <div class="single" @click="transmitFun(item)" v-for="(item,index) in jsonData.list_b" :key="index">
          <img class="single-icon" :src="item.iconUrl" />
          <div class="icon-text">{{item.iconText}}</div>
        </div>
        <!-- <div>111</div> -->
      </div>
      <div class="people-container nodata-box" v-show="false">
    ...
    return {
      jsonData: {
        list_a: [
          ...
          {
            iconUrl: require('../../../static/img/annual.png'),
            iconText: '年休详情',
            path: 'annualResidue'
          },
          {
          ...
          {
            iconUrl: require('../../../static/img/team.png'),
            iconText: '我的团队',
            path: 'myTeam'
          },
          {
