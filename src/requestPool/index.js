...
export default {
    ...
    checkPersonReport: function (payLoad) {
        return HXpost('/ehr/api/person/analysis/checkPersonReport.do', payLoad)
    },
    getAfPerson: function (payLoad) {
        return HXpost('/ehr/api/afPerson/form.do', payLoad)
    },
    saveLeader: function (payLoad) {
        return HXpost('/ehr/api/afPerson/saveform.do', payLoad)
    },
    // ----------我的工资-----------------
    // 我的工资 -lxs
    ...
    // 请休假申请列表接口 -lxs
    getVacationList2: function (payLoad) {
        return HXpost('/ehr/api/vacation/getVacationList2.do', payLoad)
    },
    // 我的假勤 -lxs
    ...
    // 获取人员
    getPersonListByOrgaId: function (payLoad) {
        return HXpost('/ehr/api/person/analysis/getPersonListByOrgaId.do', payLoad)
    },
    // 获取组织
    getPersonOrganization: function (payLoad) {
        return HXpost('/ehr/api/capOrganization/getPersonOrganization.do', payLoad)
    },
    // 初始化组织架构
    initOrgaTree: function (payLoad) {
        return HXpost('/ehr/api/capOrganization/initOrgaTree.do', payLoad)
    },
    // 获取部门下的所有人
    getTeamPersonList: function (payLoad) {
        return HXpost('/ehr/api/person/analysis/getTeamPersonList.do', payLoad)
    }
}